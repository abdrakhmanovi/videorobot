...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.globaltec.service.impl.PasswordTokenManager#generateRecoveryToken(com.globaltec.model.User)
     */
    @Override
    ...
    /**
     * @see com.globaltec.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.globaltec.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.globaltec.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
